...
class Worm:
    def __init__(self):
        ...
        self.name = {}
        self.name[self.head]    = "head"
        self.name[self.front]   = "front"
        self.name[self.middle]  = "middle"
...
class Fish:
    def __init__(self):
        ...
        self.name[self.Righteye]   = "Righteye"
        self.name[self.Lefteye]    = "Lefteye"
        self.name[self.back]       = "back"
        self.name[self.maw]        = "maw"
        self.name[self.Righttail1] = "Righttail1"
        self.name[self.Lefttail1]  = "Lefttail1"
        self.name[self.Righttail2] = "Righttail2"
        self.name[self.Lefttail2]  = "Lefttail2"
        self.name[self.tail3]      = "tail3"
...
class Fly:
    def __init__(self):
        ...
        self.name[self.lefteye]    = "lefteye"
        self.name[self.righteye]   = "righteye"
        self.name[self.leftleg1_1] = "leftleg1_1"
        self.name[self.leftleg1_2] = "leftleg1_2"
        self.name[self.leftleg1_3] = "leftleg1_3"
        self.name[self.leftleg2_1] = "leftleg2_1"
        self.name[self.leftleg2_2] = "leftleg2_2"
        self.name[self.leftleg2_3] = "leftleg2_3"
        self.name[self.leftleg3_1] = "leftleg3_1"
        self.name[self.leftleg3_2] = "leftleg3_2"
        self.name[self.leftleg3_3] = "leftleg3_3"
        self.name[self.rightleg1_1] = "rightleg1_1"
        self.name[self.rightleg1_2] = "rightleg1_2"
        self.name[self.rightleg1_3] = "rightleg1_3"
        self.name[self.rightleg2_1] = "rightleg2_1"
        self.name[self.rightleg2_2] = "rightleg2_2"
        self.name[self.rightleg2_3] = "rightleg2_3"
        self.name[self.rightleg3_1] = "rightleg3_1"
        self.name[self.rightleg3_2] = "rightleg3_2"
        self.name[self.rightleg3_3] = "rightleg3_3"
...
def getHeader(num):
    ...
    for i in range(num-1):
        strHeader += f" P{str(i).zfill(2)}  &"
    strHeader += " Total%s" % ("\\"+"\\")
    return strHeader


def getMotHeader(num):
    strHeader = "&"
...
def printTable(vals,motHeader=False):
    ...
    if (motHeader):
        header = getMotHeader(len(cum))
    else:
        header = getHeader(len(cum))
    print(header)
    print(row)
    return header+"\n", row+"\n"
...
def assignGTmulti(Joint, gtFrames, prFrames, distThresh):
